...
- 반드시 [공식 디스코드](https://universelist.kr/discord) 에 참가해주세요.
...
- 봇 리뷰어 또는 UNIVERSE 혹은 SpaceDEV 팀을 비방하거나 존중하지 않는 내용이 존재하는 봇
...
- [UNIVERSE 이용약관](/tos)을 위반하고 있거나, 한 적이 있는 경우
- [UNIVERSE 커뮤니티 이용규정](/community-rule)을 위반하여 차단 이상의 처벌을 받은 경우
