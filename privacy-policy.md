## 1. 개인정보 처리의 목적
"UNIVERSE"(' https://universelist.kr ') 는 다음 목적을 위하여 개인정보를 처리하고 있으며, 다음 목적 이외의 용도로는 사용하지 않습니다.
...
- 봇: 등록일, 디스코드 ID, 디스코드 API에서 제공하는 봇 정보(아바타, 유저네임과 태그, 디스코드 인증 여부 등), 소유자, 라이브러리, 접두사, 서버 수, 봇 설명, 카테고리
    * 선택항목: 웹사이트, GIT URL, 초대링크, 디스코드 서버 링크
...
|---------|-----------|-------------|
| PM2     | 요청 로그 등 | 서비스 및 서버 자원의 사용량 등을 모니터링, 디버깅 |
